    ...
    return ( 
      ...
      <div className="app-actions-linee">
        ...
        <button className="filter-btn more">
          <div className="filter-icon">
            <svg className="btn-icon" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sliders" viewBox="0 0 24 24">
