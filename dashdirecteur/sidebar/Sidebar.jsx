...
<g>
   ...
   <Link to="/encaddash/settingEncad"> <a href="" class="app-sidebar-link">
    ...
    <div className="wewe2">
      <Link to="/"> <a href="" className="app-sidebar-link  logout" >
